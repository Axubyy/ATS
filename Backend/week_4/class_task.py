...
class Wallet:
    ...
    def __init__(self,wallet_balance = 1000)  -> None:
            ...
            upper_letters = string.ascii_uppercase
            lower_letters = string.ascii_lowercase
            generate_wallet_address =  "".join(random.sample(random_digits,4)) + "".join(random.sample(upper_letters,3)) + "".join(random.sample(lower_letters,3))
...
class User:
    ...
    user_header = ["firstname","lastname", "username", "phone_number", "wallet_ID", "pin", "balance"]
