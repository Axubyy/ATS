...
class AuthUtils:
    def __init__(self):
        self.headers = ['first_name', 'last_name', 'username',
                        'password', 'dob', 'phone_number', 'gender', 'address']
    ...
    def save_to_csv(self, data):
        with open('user_data.csv', 'a', newline='') as new_data:
            ...
            with open('new_file.csv', 'r') as update_file:
                ...
                for i in handler:
                    if i['username'].lower() == username:
                        ...
                        i['gender'] = gender
                    data.append(i)
            with open('user_data.csv', 'w') as save_data:
    ...
    def change_password(self, username):
        ...
        if password:
            with open('user_data.csv', 'r') as update_file:
                handler = csv.DictReader(update_file)
                # w_handler = csv.DictWriter(update_file, fieldnames=headers)
                data = []
                for i in handler:
